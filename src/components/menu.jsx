  ...
  return (
    <Disclosure as="nav" className="bg-secondary  md:px-16 relative">
        <div className="flex justify-between items-center px-4 py-4 md:py-6 z-50">
            <div className="inset-y-0 flex items-center md:hidden z-50">
              {/* Mobile menu button*/}
            ...
            <div className="z-50">
            <Link to={"/"}><img src="/logo.png" className='w-10 md:w-20' alt="" /></Link>
            </div>
            ...
            <button className='rounded-full bg-primary text-white py-3 px-4 hidden lg:flex gap-x-4 items-center z-50'>
                ...
                <Link to="/contact" className='text-sm'>{t("schedule-free-consultation")}</Link>
            </button>
            <button className='rounded-full bg-primary text-white p-2 lg:hidden items-center z-50'>
                <CalendarDaysIcon className='w-5 h-5' />
            </button>
        </div>
        <DisclosurePanel className="md:hidden relative z-50">
