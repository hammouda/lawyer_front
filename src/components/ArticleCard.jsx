function ArticleCard(){
    return(
        <div className="w-100 h-[500px] p-4 bg-[#bf9845]/50 rounded-[20px] flex-col justify-start items-start gap-2.5 inline-flex">
    ...
    <div className="self-stretch text-black text-base font-light font-['Roboto'] leading-[25px] tracking-tight">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ...</div>
</div>
    );
}
