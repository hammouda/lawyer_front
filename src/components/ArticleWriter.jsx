    ...
    return(
        <>
            <div className="w-fit h-fit relative" >
                <img src={"http://127.0.0.1:8000/storage/"+props.image} className="relative rounded-[20px]"/>
            ...
            <div className="w-100 h-[55.50px] justify-between items-start inline-flex">
                <div className="relative">
                    <div className="left-10 top-0 absolute text-center text-black text-l font-normal font-['Roboto']">{props.writer}</div>
