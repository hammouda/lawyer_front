...
function Header() {
  return (
    <div className='bg-secondary px-16'>
        ...
        <div className='md:grid md:grid-cols-3 md:items-center'>
            <div className='md:col-span-2 md:ml-32'>
                <p className='text-6xl font-bold text-blue-light tracking-tighter'>
                    Experienced Lawyers,
                </p>
                <p className='text-6xl font-bold text-blue-light tracking-tighter'>
                    <span className='text-primary'>Proven</span> Results
                </p>
                <div className="mt-7 flex gap-x-8 items-center">
                ...
                <div className='flex justify-center gap-x-5 mt-16 w-96'>
            ...
            <div className="col-span-1">
                <img src="/images/woman-bg.png" className='w-72' alt="" />
            </div>
        </div>
    </div>
  )
