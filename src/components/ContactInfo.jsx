function ContactInfo() {
    ...
    <div className="flex justify-center items-center flex-wrap lg:flex-nowrap gap-8 py-5 my-14">
        <div className="flex gap-x-5 items-center">
            <img src="/images/icon-phone.png" className="w-6 md:w-12" alt="Mithaq Al Tashrie" />
        ...
        <div className="flex gap-x-5 items-center">
            <img src="/images/icon-address.png" className="w-6 md:w-12" alt="Mithaq Al Tashrie" />
            <p className="text-sm md:text-base">contact@gmail.com</p>
        </div>
        <div className="flex gap-x-5 items-center">
            <img src="/images/icon-time.png" className="w-6 md:w-12" alt="Mithaq Al Tashrie" />
